...
public class xfl_mf_trapezoid extends ParamMemFunc {
 ...
 public String toJava() {
   ...
   String code = "";
   code += "  private class MF_xfl_trapezoid extends InnerMembershipFunction {"+eol;
   code += "   double a;"+eol;
   code += "   double b;"+eol;
   code += "   double c;"+eol;
   code += "   double d;"+eol;
   code += eol+"   MF_xfl_trapezoid( double min, double max, double step, double param[]){"+eol;
 ...
 public String toC() {
   String eol = System.getProperty("line.separator", "\n");
   String code = "";
   code += "static double MF_xfl_trapezoid_equal(MembershipFunction _mf,double x) {"+eol;
   code += " double a = _mf.param[0];"+eol;
   code += " double b = _mf.param[1];"+eol;
   code += " double c = _mf.param[2];"+eol;
   code += " double d = _mf.param[3];"+eol;
   code += "  return (x<a || x>d? 0: (x<b? (x-a)/(b-a) : (x<c?1 : (d-x)/(d-c)))); "+eol;
   code += "}"+eol;
   code += "static double MF_xfl_trapezoid_greq(MembershipFunction _mf,double x) {"+eol;
   code += " double a = _mf.param[0];"+eol;
   code += " double b = _mf.param[1];"+eol;
   code += " double c = _mf.param[2];"+eol;
   code += " double d = _mf.param[3];"+eol;
   code += "  return (x<a? 0 : (x>b? 1 : (x-a)/(b-a) )); "+eol;
   code += "}"+eol;
   code += "static double MF_xfl_trapezoid_smeq(MembershipFunction _mf,double x) {"+eol;
   code += " double a = _mf.param[0];"+eol;
   code += " double b = _mf.param[1];"+eol;
   code += " double c = _mf.param[2];"+eol;
   code += " double d = _mf.param[3];"+eol;
   code += "  return (x<c? 1 : (x>d? 0 : (d-x)/(d-c) )); "+eol;
   code += "}"+eol;
   code += "static double MF_xfl_trapezoid_center(MembershipFunction _mf) {"+eol;
   code += " double a = _mf.param[0];"+eol;
   code += " double b = _mf.param[1];"+eol;
   code += " double c = _mf.param[2];"+eol;
   code += " double d = _mf.param[3];"+eol;
   code += "  return (b+c)/2; "+eol;
   code += "}"+eol;
   code += "static double MF_xfl_trapezoid_basis(MembershipFunction _mf) {"+eol;
   code += " double a = _mf.param[0];"+eol;
   code += " double b = _mf.param[1];"+eol;
   code += " double c = _mf.param[2];"+eol;
   code += " double d = _mf.param[3];"+eol;
   code += "  return (d-a); "+eol;
   code += "}"+eol;
   code += "static MembershipFunction createMF_xfl_trapezoid( double min, double max, double step, double *param,int length) {"+eol;
   code += " int i;"+eol;
   ...
   code += " _mf.compute_eq = MF_xfl_trapezoid_equal;"+eol;
   code += " _mf.compute_greq = MF_xfl_trapezoid_greq;"+eol;
   code += " _mf.compute_smeq = MF_xfl_trapezoid_smeq;"+eol;
   code += " _mf.center = MF_xfl_trapezoid_center;"+eol;
   code += " _mf.basis = MF_xfl_trapezoid_basis;"+eol;
   code += " return _mf;"+eol;
   code += "}"+eol;
   return code;
  }
 public String toCpp(String name) {
   ...
   code += " double param[4] = {a,b,c,d};"+eol;
   code += " return new "+name+"(min,max,step,param,4);"+eol;
   code += "}"+eol+eol;
